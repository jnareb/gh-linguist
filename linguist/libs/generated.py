...
class Generated(object):
    ...
    def is_compiled_coffeescript(self):
        ...
        if len(lines) > 0 \
                and re.compile(r'^// Generated by ', re.DOTALL).search(lines[0]):
            return True
        ...
        if len(lines) > 2 \
            ...
            for line in lines:
                if re.compile(r'var ', re.DOTALL).search(line):
    ...
    def is_generated_parser(self):
        ...
        if re.compile(r'^(?:[^/]|/[^*])*/\*(?:[^*]|\*[^/])*Generated by PEG.js', re.DOTALL).search(''.join(lines[0:5])):
            return True
        return False
    ...
    def is_node_modules(self):
        ...
        Returns true or false.
        """
        return bool(re.compile(r'node_modules/').search(self.name))
